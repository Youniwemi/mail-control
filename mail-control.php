 ...
 * Description: Design and customize emails, send using smtp, log and track emails clicks and openings, and allow sending the emails as a background task for speed
 * License: GPL
